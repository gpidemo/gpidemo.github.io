                ...
                instrumentResponse.complete('success')
                    .then(function() {
                       if (instrumentResponse.methodName !== "basic-card") {
                        basicPopup ('https://gpidemo.github.io/pr/apps/origin/getstatus.html#' + instrumentResponse.details.uetr + '#Payment Initiated#' + instrumentResponse.details.account.iban);
